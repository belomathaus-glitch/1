    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 backdrop-blur-md bg-imperial-purple-900/50 p-6 rounded-xl border border-imperial-purple-800/80 shadow-xl">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-white text-center">Criar uma nova conta</h3>
          </div>
            ...
            <div>
              ...
              >
                {isLoading ? (
                  ...
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                    <User size={16} className="text-imperial-purple-300 group-hover:text-imperial-purple-200" />
                  </span>
                )}
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-400">
            Já tem uma conta?{' '}
            <Link to="/login" className="font-medium text-imperial-purple-400 hover:text-imperial-purple-300 transition-colors">
              Entre aqui
            </Link>
          </p>
        </div>
